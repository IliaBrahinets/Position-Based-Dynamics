...
namespace PositionBasedDynamics.Collisions
{
    ...
    public class ParticleHashTest
    {
        ...
        public ParticleHashTest(int numParticles, double cellSize, int maxNeighbors = 60, int maxParticlesPerCell = 50)
        {
                        ...
                        for (int m = 0; m < count; m++)
                        {
                            ...
                            if (dist2 < r2)
                            {
                                if (NumNeighbors[i] < MaxNeighbors){
                                    Neighbors[i*MaxNeighbors +  NumNeighbors[i]++] = pi;
                                }
                                else
